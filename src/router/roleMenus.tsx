...
export const roleMenus: Record<Role, RoleMenuItem[]> = {
  ...
  finance: [
    ...
    { path: '/system/users', label: '员工管理', icon: <TeamOutlined /> },
    {
      ...
      children: [
        ...
        { path: '/data/ocr', label: 'OCR识别', icon: <FileImageOutlined /> },
        { path: '/data/ocr-tasks', label: 'OCR任务', icon: <FileSearchOutlined /> },
  ...
  boss: [
    ...
    { path: '/boss/system/users', label: '员工管理', icon: <TeamOutlined /> },
    {
      ...
      icon: <FolderOpenOutlined />,
      children: [
        { path: '/boss/projects', label: '项目概览', icon: <FolderOpenOutlined /> },
