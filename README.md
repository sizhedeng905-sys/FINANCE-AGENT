...
| AI 映射补充 M0-M8 | `M0-M2_passed / M3_next` | M2 完成严格输出/白名单/失败关闭、9 Prompt + core guard、完整版本向量和 5 类 Mock 故障；44/44 后端 suites、8/8 PostgreSQL suites、30 条 migration 空库/升级通过；Prompt Catalog 空文件仍阻塞逐字目录核对 |
