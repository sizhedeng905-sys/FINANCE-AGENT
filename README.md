...
| R11 最终交接 | `in_progress` | CR-010 至 CR-013 已推送且远端全绿；CR-014 服务端审核决定/provenance 本地工程验收通过，下一项是提交、远端同 SHA 验证和确认页证据摘要；三次人工演练未执行，不 merge、不转 Ready |
...
| 最新已推送 GitHub Build | `passed` | CR-013 SHA `7d363f6` 的 run `29831004356` 两个 job 全部成功；CR-014 尚待提交后取得同 SHA 证据 |
| 最新 GitHub CodeQL | `passed` | CR-013 SHA `7d363f6` 的 run `29831004341` 成功；CR-014 尚待提交后取得同 SHA 证据 |
