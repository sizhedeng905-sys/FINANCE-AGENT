...
| AI 映射补充 M0-M8 | `engineering_passed_with_external_and_human_gates` | OCR/Excel 审核入账、canonical ReportSnapshot、严格 Claim grounding、攻击/资源/降级和最终证据已通过；Prompt Catalog、真实口径/准确率、Staging、推送和签字仍未关闭 |
