...
| AI 映射补充 M0-M8 | `M0-M3_passed / M4_next` | Excel 只按列摘要调用分类/映射，严格校验项目模板、字段、证据和转换白名单；调用具备内容哈希、租约接管、重试耗尽和状态变化失败关闭；34 条 migration 双路径、后端 401/401 和 PostgreSQL 92/92 通过 |
