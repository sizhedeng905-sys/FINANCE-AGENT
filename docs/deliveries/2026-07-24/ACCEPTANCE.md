...
| CR-016 批准证据与批次记录定位 | 本地提交 `435acce`；先红灯复现批准后进入未过滤记录页；修复后周五故事 1/1、Excel 4/4、完整 Playwright 21/21、runtime 4/4、production build 通过，文件残留 0 | `LOCAL_PASS / REMOTE_PUSH_BLOCKED_EXTERNAL` |
