...
在新远端 run 结束前，R8.9 状态保持 `awaiting_remote_ci`，不能写成 `verified`。目标 Linux Staging、跨版本 rollback、真实财务/OCR/AI 真值和 H01-H16 签字仍是独立门禁，本修复不改变项目“非 production-ready”的结论。
