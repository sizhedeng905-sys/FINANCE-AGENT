...
当前批次：真实业务数据 B0-B2 已完成，B3 OCR/视觉真值基线进行中
...
| I 真实业务数据 | B0-B2 完成，B3 进行中 | 112 个文件只读结构基线、图片/PDF 安全、多 Sheet/表头/公式、媒体流式隔离、30196 行后台门禁、15 份 `.xls` 与 50 MiB 精确边界已通过；下一步验证真实模型准确率 |
