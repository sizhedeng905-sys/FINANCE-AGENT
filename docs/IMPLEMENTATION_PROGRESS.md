...
| M0-M8 AI 分类/映射/审批/快照补充 | M0-M3 完成 / M4 待继续 | Excel 列级 AI 分类/映射、严格白名单、内容寻址调用、租约/重试、状态变化失败关闭和精确 Mapping Profile 已完成；34 条 migration 空库及 33→34 升级、后端 401/401、PostgreSQL 92/92 通过 |
